...
# La validación de longitud mínima del título se realiza en el esquema TaskCreate
...
def update_task(task_id: int, payload: TaskUpdate, db: Session = Depends(get_db)):
    ...
    # Una tarea ya completada no puede modificarse para preservar su inmutabilidad
